...
//        private float[] m_Values = new float[]{100.13636779f,100.13636779f,99.97434997f,99.91627502f,99.84027862f,99.73872375f,99.68705749f,99.57246398f,99.53229522f,99.43615722f,99.36226654f,99.31098937f,99.23509216f,99.24930572f,99.26844787f,99.13729095f,99.08396911f,99.02206420f,98.97335052f,98.93831634f,98.93999481f,98.93376159f,98.85617065f,98.82410430f,98.81771087f,98.78941345f,98.76016998f,98.71606445f,98.71911621f,98.71027374f,98.67870330f,98.63468170f,98.61227416f,98.60410308f,98.54369354f,98.53150177f,98.51820373f,98.48543548f,98.53021240f,98.47772216f,98.44147491f,98.46871185f,98.45572662f,98.38578033f,98.37026977f,98.37981414f,98.40867614f,98.32593536f,98.32688903f,98.32901763f,98.30844116f,98.32727050f,98.26142883f,98.25404357f,98.24216461f,98.23987579f,98.20009613f,98.18412017f,98.19174957f,98.17549133f,98.13902282f,98.15258789f,
//98.13761138f,98.11972808f,98.12406921f,98.07202911f,98.14785766f,98.07659912f,98.07180023f,98.04254150f,98.10493469f,98.02767944f,98.03502655f,98.04147338f,98.04965209f,98.06535339f,98.05857849f,97.99221801f,98.05194091f,
//98.03771972f,98.06079101f,97.98467254f,98.01860046f,98.00945281f,97.99611663f,97.99231719f,97.99811553f,97.96549224f,97.97451019f,97.95214843f,97.90617370f,97.87899017f,
//97.93210601f,98.03022766f,98.75674438f,101.56599426f,106.13615417f,111.65046691f,118.45186614f,127.23332214f,139.02624511f,158.48130798f,187.01391601f,213.13674926f,223.35366821f,219.35095214f,208.64784240f,196.13702392f,183.80505371f,172.68417358f,163.17459106f,155.22027587f,148.58549499f,142.80096435f,137.69763183f,133.09973144f,129.04780578f,125.45522308f,122.26302337f,119.45645141f,117.00534820f,
//114.81840515f,113.02484130f,111.29143524f,109.88728332f,108.62644195f,107.64141845f,106.55022430f,105.81355285f,105.10055541f,104.48545837f,103.90827941f,103.43152618f,103.01782989f,102.66262817f,102.30013275f,102.05798339f,
//101.81026458f,101.59600067f,101.43446350f,101.25779724f,101.13021850f,100.94995880f,100.79347991f,100.66439819f,100.54563140f,}; //Yaxis value
        ...
        public Bitmap CreateImage(string []keys_, float []values_)
        {
            
            float[] values = new float[values_.Length];
            string[] keys = new string[keys_.Length];
            ...
            InitializeGraph(keys);
            DrawContent(ref objGraphics, values, keys);

            return objBitmap;
        }

        //generating and fullfill image area, draw border, initialize title
        private void InitializeGraph(string[] Keys)
        {
        ...
        private void SetXAxis(ref Graphics objGraphics, string[] Keys)
        {
            int x1 = 100;
            int y1 = Height - 110;
            int x2 = 100;
        ...
        private void DrawContent(ref Graphics objGraphics, float []Values, string []Keys)
        {
